...
export type OauthToken = {
  body: {
    ...
    /* This parameter is for the authorization code received from the authorization server which will be in the query string parameter “code” in this request. */code: string;
...
export const oauthTokenCreated = typed.object({
  ...
  /* UTC Unix TimeStamp when the access token expires */expires_in: typed.number.optional
});
